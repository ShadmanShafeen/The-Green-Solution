            ...
            <div className={styles.search_container}>
                ...
                <Link>
                    <motion.button
                        ...
                        whileTap={{scale: 0.9}}
                        onClick={handleAsk}
                    ><svg xmlns="http://www.w3.org/2000/svg" width="23" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
